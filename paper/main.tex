...
%%%   \newcommand{\LeanStatus}{inprogress}   %  delta = 2 still building
%%%   \newcommand{\LeanStatus}{complete}     %  F(11) assembled and gated
\newcommand{\LeanStatus}{inprogress}
\newif\ifleandone
\makeatletter
...
transcript to \texttt{GATE.txt}. The check does pass, currently on $97$ listed theorems.
