...
For $d \ge 8$ non-attainment already follows from Wellens' explicit bounds; the new range is
$3 \le d \le 7$. Second, we determine $R_3$ exactly: $R_3 = 10$, attained by the Chiarelli--Hatami--Saks
...
for $3 \le d \le 7$ it was still the best published upper bound; and the exact values of $R_d$ have not
...
\subsection{Results}
We settle the tightness of \eqref{eq:ns} for every $d$ (new for $3 \le d \le 7$; for $d \ge 8$
it follows from \cite{Wel19}), with one uniform structural proof, and determine $R_3$.
...
\eqref{eq:ns} for $3 \le d \le 7$. A literature sweep carried out for this project found no paper,
...
best of our knowledge, Theorem~\ref{thm:main-r3}, Theorem~\ref{thm:main-ns} for $3 \le d \le 7$, and
Lemma~\ref{lem:A} are new.
